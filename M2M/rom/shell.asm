...
HANDLE_IO       SYSCALL(enter, 1)
                ...
                ; Ported verbatim from AExp (sy2002/AExp, exception
                ; "core-io-hook" in that project's own AGENTS.md), which hit
                ; the same problem for its Amiga ADF floppy write-back - see
                ; QL4M65's DECISIONES.md, M2028 section.
