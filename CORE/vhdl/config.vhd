...
-- QL4M65 (Milestone 2 phase A): "Microdrive" section added the same way,
...
-- QL4M65 (Milestone 2 phase B, etapa 3, M2026): had a "Save mdv1" momentary
-- action here for one build. Removed again in etapa 4 (M2028): the SD
...
-- No submenus here, so OPTM_DY = OPTM_SIZE (all lines always visible).
