...
**Pendiente ahora:**
- Prueba en hardware real de `QL4M65-CoreQL-M1007_r6.cor` (overlay de
  depuración con `cpu_addr` en pantalla, para confirmar/acotar la hipótesis
  del "avance lentísimo" descubierta en `M1006` - ver tabla de pruebas abajo
  y `DECISIONES.md`).
