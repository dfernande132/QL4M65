...
## 0. Estado actual del proyecto (actualizado: 2026-08-17 — Milestone 2 fase A cerrada y publicada; fase B etapa 1 CERRADA (M2024); etapa 2 (M2025) compilada y confirmada; etapa 3 (M2026) compilada pero con bug real en hardware (volcado a SD corrompía sectores) — causa raíz encontrada, arreglada y recompilada en M2027 (compila limpio, todas las restricciones cumplidas), pendiente de volver a probar en hardware. Solo R6 hasta cerrar Milestone 2 en las dos placas)
