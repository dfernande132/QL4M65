...
## 0. Estado actual del proyecto (actualizado: 2026-08-24 — **Milestone 3 CERRADO y confirmado en hardware real. RAM 128k/640k/1024k y velocidad de CPU nativo/16MHz/24MHz/Full, ambas seleccionables desde el menú OSD. Pendiente: decidir con el usuario una release "V1.0" en GitHub.**)
...
Pendiente: decisión con el usuario sobre publicar una release "V1.0" en GitHub (primera vez que este proyecto usaría un nombre de versión semántico en vez del número de build interno `Mxxxx`) - ver la conversación en curso para el razonamiento. Milestone 4 (QL-SD/QXL.WIN) sigue pausado desde 2026-08-04, no cancelado.
