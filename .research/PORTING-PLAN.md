...
## 0. Estado actual del proyecto (actualizado: 2026-08-17 — Milestone 2 fase A cerrada y publicada; fase B etapa 1 CERRADA (M2024); etapa 2 (M2025) confirmada; etapa 3 CERRADA en M2027 (menú "Save mdv1" + volcado real a SD, confirmado en hardware con 0 fallos de 765 checksums tras el fix del bug de M2026). Solo R6 hasta cerrar Milestone 2 en las dos placas)
