...
## 0. Estado actual del proyecto (actualizado: 2026-08-24 — **Milestone 2 cerrado. Milestone 3: RAM 128k/640k/1024k confirmada en hardware real (`M3003`). Velocidad de CPU (nativo/16MHz/24MHz/Full) implementada en `M3004`, pendiente de confirmación en hardware — con esto se completa el alcance original de Milestone 3.**)
